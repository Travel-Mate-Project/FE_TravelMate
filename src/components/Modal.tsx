...
import {getHeightClass} from '@/util/getHeightClass';

export default function Modal({children, title, modalHeight = 90}: ModalProps) {
  ...
  const heightClass = getHeightClass(modalHeight);
  ...
  return (
    ...
    >
      <div
        ...
        className={`
         absolute bottom-0
          bg-white w-full ${heightClass} max-w-md rounded-t-2xl shadow-lg
